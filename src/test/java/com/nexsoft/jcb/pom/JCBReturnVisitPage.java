...
public class JCBReturnVisitPage {
	...
	public JCBReturnVisitPage(WebDriver driver) {
		this.driver = driver;
	}
	...
	public JCBReturnVisitPage clickBtnSaveDataMerchant() {
		saveEditBtn.click();
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);

	}

	public JCBReturnVisitPage clickBtnEditDataMerchant() {
		editDataMerchBtn.click();
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);

	}

	public JCBReturnVisitPage clickBtnCancelEditDataMerchant() {
		cancelEditDataMerchBtn.click();
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);

	}

	public JCBReturnVisitPage clickPICDataMerchant(String pic) {
	...
	public JCBReturnVisitPage clicknoTelpPICDataMerchant(String telp) {
	...
	public JCBReturnVisitPage clickSearchField(String pic) {
		PICDataMerchField.sendKeys(pic);
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);

	}

	public JCBReturnVisitPage LogOut() {
		profile.click();
		btnLogout.click();
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);
	}
	...
	public JCBReturnVisitPage selectDropdownListPICEntriesByValue(String value) {
		Select select = new Select(selectPICDataMerch);
		select.selectByValue(value);
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);
	}

	public JCBReturnVisitPage selectDropdownListMerchEntriesByValue(String value) {
		Select select = new Select(selectMerchantAccDataMerch);
		select.selectByValue(value);
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);
	}

	public JCBReturnVisitPage clickBtnAddTID() {
		addTIDBtn.click();
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);
	}

	public JCBReturnVisitPage selectDropdownListBankEntriesByValue(String value) {
		Select select = new Select(fieldBank);
		select.selectByVisibleText(value);
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);
	}

	public JCBReturnVisitPage inputMID(String MID) {
		fieldMID.sendKeys(MID);
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);
	}

	public JCBReturnVisitPage inputTID(String TID) {
		fieldTID.sendKeys(TID);
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);
	}

	public JCBReturnVisitPage selectDropdownListJCBAccEntriesByValue(String value) {
		Select select = new Select(fieldJCBAcc);
		select.selectByValue(value);
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);
	}

	public JCBReturnVisitPage selectDropdownListEDCIssueEntriesByValue(String value) {
		Select select = new Select(fieldEDCIssue);
		select.selectByValue(value);
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);
	}

	public JCBReturnVisitPage clickBtnChooseFile(String filePath) {
		chooseFileBtn.sendKeys(filePath);
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);
	}

	public JCBReturnVisitPage clickBtnSaveAddTID() {
		saveAddTIDBtn.click();
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);

	}

	public JCBReturnVisitPage clickBtnCancelAddTID() {
		cancelTIDBtn.click();
		return PageFactory.initElements(driver, JCBReturnVisitPage.class);
