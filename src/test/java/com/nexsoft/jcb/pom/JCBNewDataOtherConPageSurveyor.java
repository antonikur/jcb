...
public class JCBNewDataOtherConPageSurveyor {
	...
	public JCBNewDataOtherConPageSurveyor(WebDriver driver) {
		this.driver = driver;
	}

	public JCBNewDataOtherConPageSurveyor selectDropdownListVisitStatusByValue(String value) {
		Select select = new Select(visitStatusDropDown);
		select.selectByValue(value);
		return PageFactory.initElements(driver, JCBNewDataOtherConPageSurveyor.class);
	}

	public JCBNewDataPage clickBtnSubmit() {
		submitBtn.click();
		return PageFactory.initElements(driver, JCBNewDataPage.class);
	}

	public JCBNewDataOtherConPageSurveyor inputOtherVisitStatus(String text) {
