...
public class JCBNewDataOtherConPage {
	...
	public JCBNewDataOtherConPage(WebDriver driver) {
		this.driver = driver;
	}

	public JCBNewDataOtherConPage selectDropdownListVisitStatusByValue(String value) {
	...
	public JCBNewDataOtherConPage inputOtherVisitStatus(String text) {
