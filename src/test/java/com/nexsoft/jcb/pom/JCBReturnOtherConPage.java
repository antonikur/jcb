...
public class JCBReturnOtherConPage {
	...
	public JCBReturnOtherConPage(WebDriver driver) {
		this.driver = driver;
	}

	public JCBReturnOtherConPage selectDropdownListVisitStatusByValue(String value) {
	...
	public JCBReturnOtherConPage inputOtherVisitStatus(String text) {
