...
public class JCBReturnOtherConPageSurveyor {
	...
	public JCBReturnOtherConPageSurveyor(WebDriver driver) {
		this.driver = driver;
	}

	public JCBReturnOtherConPageSurveyor selectDropdownListVisitStatusByValue(String value) {
		Select select = new Select(visitStatusDropDown);
		select.selectByValue(value);
		return PageFactory.initElements(driver, JCBReturnOtherConPageSurveyor.class);
	}

	public JCBReturnPage clickBtnSubmit() {
		submitBtn.click();
		return PageFactory.initElements(driver, JCBReturnPage.class);
	}

	public JCBReturnOtherConPageSurveyor inputOtherVisitStatus(String text) {
