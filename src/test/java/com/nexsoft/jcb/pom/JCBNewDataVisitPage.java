...
public class JCBNewDataVisitPage {
	...
	public JCBNewDataVisitPage clickBtnSaveDataMerchant() {
		saveEditBtn.click();
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);

	}

	public JCBNewDataVisitPage clickBtnEditDataMerchant() {
		editDataMerchBtn.click();
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);

	}

	public JCBNewDataVisitPage clickBtnCancelEditDataMerchant() {
		cancelEditDataMerchBtn.click();
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);

	}

	public JCBNewDataVisitPage clickPICDataMerchant(String pic) {
	...
	public JCBNewDataVisitPage clicknoTelpPICDataMerchant(String telp) {
	...
	public JCBNewDataVisitPage clickSearchField(String pic) {
		PICDataMerchField.sendKeys(pic);
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);

	}

	public JCBNewDataVisitPage LogOut() {
		profile.click();
		btnLogout.click();
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);
	}
	...
	public JCBNewDataVisitPage selectDropdownListPICEntriesByValue(String value) {
		Select select = new Select(selectPICDataMerch);
		select.selectByValue(value);
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);
	}

	public JCBNewDataVisitPage selectDropdownListMerchEntriesByValue(String value) {
		Select select = new Select(selectMerchantAccDataMerch);
		select.selectByValue(value);
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);
	}

	public JCBNewDataVisitPage clickBtnAddTID() {
		addTIDBtn.click();
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);
	}

	public JCBNewDataVisitPage selectDropdownListBankEntriesByValue(String value) {
		Select select = new Select(fieldBank);
		select.selectByVisibleText(value);
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);
	}

	public JCBNewDataVisitPage inputMID(String MID) {
		fieldMID.sendKeys(MID);
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);
	}

	public JCBNewDataVisitPage inputTID(String TID) {
		fieldTID.sendKeys(TID);
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);
	}

	public JCBNewDataVisitPage selectDropdownListJCBAccEntriesByValue(String value) {
		Select select = new Select(fieldJCBAcc);
		select.selectByValue(value);
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);
	}

	public JCBNewDataVisitPage selectDropdownListEDCIssueEntriesByValue(String value) {
		Select select = new Select(fieldEDCIssue);
		select.selectByValue(value);
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);
	}

	public JCBNewDataVisitPage clickBtnChooseFile(String filePath) {
		chooseFileBtn.sendKeys(filePath);
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);
	}

	public JCBNewDataVisitPage clickBtnSaveAddTID() {
		saveAddTIDBtn.click();
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);

	}

	public JCBNewDataVisitPage clickBtnCancelAddTID() {
		cancelTIDBtn.click();
		return PageFactory.initElements(driver, JCBNewDataVisitPage.class);
