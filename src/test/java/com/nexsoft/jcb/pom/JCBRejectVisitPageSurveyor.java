...
public class JCBRejectVisitPageSurveyor {
	...
	public JCBRejectVisitPageSurveyor(WebDriver driver) {
		this.driver = driver;
	}
	...
	public JCBRejectVisitPageSurveyor clickBtnSaveDataMerchant() {
		saveEditBtn.click();
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);

	}

	public JCBRejectVisitPageSurveyor clickBtnEditDataMerchant() {
		editDataMerchBtn.click();
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);

	}

	public JCBRejectVisitPageSurveyor clickBtnCancelEditDataMerchant() {
		cancelEditDataMerchBtn.click();
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);

	}

	public JCBRejectVisitPageSurveyor clickPICDataMerchant(String pic) {
	...
	public JCBRejectVisitPageSurveyor clicknoTelpPICDataMerchant(String telp) {
	...
	public JCBRejectVisitPageSurveyor clickSearchField(String pic) {
		PICDataMerchField.sendKeys(pic);
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);

	}

	public JCBRejectVisitPageSurveyor LogOut() {
		profile.click();
		btnLogout.click();
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);
	}
	...
	public JCBRejectVisitPageSurveyor selectDropdownListPICEntriesByValue(String value) {
		Select select = new Select(selectPICDataMerch);
		select.selectByValue(value);
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);
	}

	public JCBRejectVisitPageSurveyor selectDropdownListMerchEntriesByValue(String value) {
		Select select = new Select(selectMerchantAccDataMerch);
		select.selectByValue(value);
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);
	}

	public JCBRejectVisitPageSurveyor clickBtnAddTID() {
		addTIDBtn.click();
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);
	}

	public JCBRejectVisitPageSurveyor selectDropdownListBankEntriesByValue(String value) {
		Select select = new Select(fieldBank);
		select.selectByVisibleText(value);
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);
	}

	public JCBRejectVisitPageSurveyor inputMID(String MID) {
		fieldMID.sendKeys(MID);
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);
	}

	public JCBRejectVisitPageSurveyor inputTID(String TID) {
		fieldTID.sendKeys(TID);
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);
	}

	public JCBRejectVisitPageSurveyor selectDropdownListJCBAccEntriesByValue(String value) {
		Select select = new Select(fieldJCBAcc);
		select.selectByValue(value);
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);
	}

	public JCBRejectVisitPageSurveyor selectDropdownListEDCIssueEntriesByValue(String value) {
		Select select = new Select(fieldEDCIssue);
		select.selectByValue(value);
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);
	}

	public JCBRejectVisitPageSurveyor clickBtnChooseFile(String filePath) {
		chooseFileBtn.sendKeys(filePath);
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);
	}

	public JCBRejectVisitPageSurveyor clickBtnSaveAddTID() {
		saveAddTIDBtn.click();
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);

	}

	public JCBRejectVisitPageSurveyor clickBtnCancelAddTID() {
		cancelTIDBtn.click();
		return PageFactory.initElements(driver, JCBRejectVisitPageSurveyor.class);
